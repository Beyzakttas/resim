...
ANALYSIS_PROFILES = [
    ...
    {"score_max": 40, "emotion": "**Yaratıcı**", "base_psychology": "Yaratıcı enerjinin doğal akışı. **İlham** ve hayal gücünün coşkuyla ifadesi. Duygular akıcı, spontane ve otantik.", "detail_score": "37/100"},
